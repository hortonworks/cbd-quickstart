...
> We are using the latest CentOS based images with cloud-init (CI)
```
...
The version of the image in the generated template is configured as an environment variable in the Makefile. To update only the variable needs to be overridden in the Makefile.
```
