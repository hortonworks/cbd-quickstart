...
## Deploy 2.16.0-dev.31 via gcloud command line interface by using template config
...
gcloud deployment-manager deployments create cbd-deployment \
    ...
    --properties region:us-central1,zone:us-central1-a,instance_type:n1-standard-4,os_user:cloudbreak,user_email:admin@example.com,user_password:'cloudbreak',cbd_version:2.16.0-dev.31,startup-script:'https://raw.githubusercontent.com/hortonworks/cbd-quickstart/2.16.0-dev.31/install-and-start-cbd.sh',source_image:centos-7-v20190619,ssh_pub_key:'...',service_account_email:'...'
```
