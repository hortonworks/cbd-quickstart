...
## Deploy 2.8.0-dev.187 via gcloud command line interface by using template config
...
gcloud deployment-manager deployments create cbd-deployment \
    ...
    --properties region:us-central1,zone:us-central1-a,instance_type:n1-standard-4,os_user:cloudbreak,user_email:admin@example.com,user_password:'cloudbreak',cbd_version:2.8.0-dev.187,startup-script:'https://raw.githubusercontent.com/hortonworks/cbd-quickstart/2.8.0-dev.187/install-and-start-cbd.sh',source_image:centos-7-v20180523,ssh_pub_key:'....',service_account_email:'..'
```
